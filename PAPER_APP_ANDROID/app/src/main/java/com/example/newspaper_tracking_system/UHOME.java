...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
           startActivity(new Intent(getApplicationContext(),View_agent_subscription_status.class));
        }  else if (id == R.id.nav_tools) {
            startActivity(new Intent(getApplicationContext(),view_notification.class));
        }
        else if (id == R.id.my) {
            startActivity(new Intent(getApplicationContext(),View_my_agents.class));
        }else if (id == R.id.nav_share) {
            startActivity(new Intent(getApplicationContext(),view_payment_history.class));
        } else if (id == R.id.upstat) {
            startActivity(new Intent(getApplicationContext(),Update_status.class));
        }
